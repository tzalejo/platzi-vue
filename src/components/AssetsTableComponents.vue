  ...
  <table>
    <thead>
      <tr class="bg-gray-100 border-b-2 border-gray-400">
        ...
        <td class="hidden sm:block">
          <input
            v-model="filter"
            class="db-gray-100 focus:outline-none border-b border-gray-400 py-2 px-4 block w-full appearance-none leading-normal"
            id="filter"
            placeholder="Buscar..."
            type="text"
          />
    ...
    <tbody>
      ...
      >
        ...
        <td class="hidden sm:block">
          <button-components @custom-click="toToCoin(a.id)">
            <span>Detalle</span>
          </button-components>
        </td>
      </tr>
